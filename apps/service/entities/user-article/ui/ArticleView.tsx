...
export default function ArticleView({ data }: ArticleViewProps) {
  ...
  return (
    <div className="h-auto min-h-dvh w-full p-5">
      <div className="mb-7">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <p className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
            ...
            <span className="inline-block whitespace-nowrap rounded-full bg-blue-50 px-2 py-1 text-sm text-blue-400 dark:bg-blue-800">
