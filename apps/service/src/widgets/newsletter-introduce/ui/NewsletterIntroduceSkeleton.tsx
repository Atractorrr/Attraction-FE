...
function NewsletterIntroduceProfileSkeleton() {
  return (
    <Container className="flex gap-x-6 p-5">
      <div className="h-[208px] w-48 shrink-0 rounded-md bg-gray-100 dark:bg-gray-700" />
      <div className="w-full">
        <div className="flex w-full flex-col gap-y-2">
          <div className="h-5 w-full max-w-[48%] rounded-md bg-gray-100 dark:bg-gray-700" />
          <div className="flex w-full gap-x-2">
            <div className="h-5 w-full max-w-[10%] rounded-md bg-gray-100 dark:bg-gray-700" />
            <div className="h-5 w-full max-w-[12%] rounded-md bg-gray-100 dark:bg-gray-700" />
          </div>
        </div>
        <div className="mt-7 flex w-full flex-col gap-y-2">
          <div className="h-5 w-full max-w-[80%] rounded-md bg-gray-100 dark:bg-gray-700" />
          <div className="h-5 w-full max-w-[52%] rounded-md bg-gray-100 dark:bg-gray-700" />
          <div className="h-5 w-full max-w-[60%] rounded-md bg-gray-100 dark:bg-gray-700" />
        </div>
      </div>
    </Container>
  )
