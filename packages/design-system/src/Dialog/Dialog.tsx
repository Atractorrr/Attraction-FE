...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'ds-fixed ds-left-[50%] ds-top-[50%] ds-z-50 ds-grid ds-w-full ds-min-w-60 ds-max-w-[calc(100vw-2.5rem)] ds-translate-x-[-50%] ds-translate-y-[-50%] ds-gap-4 ds-rounded-xl ds-border ds-border-gray-100 ds-bg-white ds-p-5 ds-shadow-lg ds-duration-200 data-[state=open]:ds-animate-in data-[state=closed]:ds-animate-out data-[state=closed]:ds-fade-out-0 data-[state=open]:ds-fade-in-0 data-[state=closed]:ds-zoom-out-95 data-[state=open]:ds-zoom-in-95 data-[state=closed]:ds-slide-out-to-left-1/2 data-[state=closed]:ds-slide-out-to-top-[48%] data-[state=open]:ds-slide-in-from-left-1/2 data-[state=open]:ds-slide-in-from-top-[48%] sm:ds-max-w-lg dark:ds-border-gray-800 dark:ds-bg-gray-800',
        className,
      )}
      {...props}>
      {children}
...
function DialogFooter({
  ...
  return (
    <div
      className={cn(
        'ds-flex ds-items-center ds-justify-center ds-gap-2 sm:ds-justify-end',
        className,
      )}
      {...props}
    />
