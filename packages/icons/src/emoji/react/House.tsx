...
const SvgHouse = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    <g clipPath="url(#house_svg__a)">
      ...
      <path
        fill="#FCC21B"
        d="m106.668 53.325-42.9-39.047c-2.072-1.884-5.465-1.884-7.537 0L13.32 53.325c-2.071 1.894-3.768 5.728-3.768 8.531v53.053c0 2.803 2.297 5.1 5.09 5.1H34.34V85.012c0-2.137 1.744-3.88 3.872-3.88h15.525a3.895 3.895 0 0 1 3.881 3.88V120h47.728c2.804 0 5.1-2.288 5.1-5.1V61.847c0-2.794-1.696-6.638-3.778-8.522M82.059 95.38h-5.54c-2.588 0-4.716-2.119-4.716-4.716v-4.734h10.256zm0-13.95H71.803v-6.347c0-2.587 2.128-4.715 4.715-4.715h5.541zm14.747 9.234c0 2.588-2.119 4.716-4.716 4.716h-5.54v-9.45h10.256zm0-9.234H86.559V70.378h5.54a4.725 4.725 0 0 1 4.716 4.716v6.337z"
      />
      <mask
        id="house_svg__b"
        width={102}
